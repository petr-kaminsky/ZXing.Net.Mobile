...
namespace ZXing.Mobile
{
	public class ZxingOverlayView : View 
	{
		...
		public ZxingOverlayView(Context context, IAttributeSet attrs) : base(context)
		{
			Initialize();
		}
		...
		protected override void OnDraw (Canvas canvas)
		{
			...
			string topText = this.TopText ?? string.Empty;
			...
			string bottomText = this.BottomText ?? string.Empty;
